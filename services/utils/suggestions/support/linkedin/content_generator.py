...
def process_linkedin_post(post_data: Dict[str, Any], api_key_pool: APIKeyPool, media_dir: str, verbose: bool = False) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "original_caption": post_data.get('data', {}).get('text', ''),
...
def run_linkedin_content_generation(profile_name: str) -> Dict[str, Any]:
...
def generate_new_linkedin_tweets_from_filtered(profile_name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if result:
            ...
            for section in sections:
                ...
                if section and len(section) > 20 and post_count < num_posts:
                    new_posts.append({
                        "id": f"new_linkedin_{int(time.time())}_{post_count}",
                        "text": section,
                        "approved": False
                    })
                    post_count += 1
        ...
        new_posts_content = {
            ...
            "metadata": {
                ...
                "total_new_posts_generated": len(new_posts),
